...
<jsp:useBean id="db" class="pkg.connection" scope="page" />
    <%
		...
		ResultSet rs = db.executeQuery("select * from sys_user where username = '" + username + "'");
		rs.next();
	%>
        <div id="mainFrame">
            <!--头部与导航start-->
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="no" width="100%" frameBorder=0 id=frmleft name=frmleft src="leftPages/JG_accordition.html" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" width="100%" height="1200px" frameBorder=0 id=frmright name=frmright src="temp/open.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
