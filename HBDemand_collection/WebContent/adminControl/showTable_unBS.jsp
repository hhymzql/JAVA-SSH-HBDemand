...
<div align="center" style="margin-top:50px;margin-bottom:50px">未技术审核的征集表信息</div>
...
try{
    ...
    String sql = "select NO,cmadName,keyword1,keyword2,SHstate from tb_Comand where SHstate = 1 and XSstate = 1 and BSstate = 0 and fpbm='"+fpbm+"'";
    ...
    do{  
    	...
    	+"</td><td>"+shs+"</td><td><a href='../adminControl/showTable_ss.jsp?NO="+no
    	+"'>查看</a></td></tr>"); 
	}while(rs.next());
    	db.close();
}
