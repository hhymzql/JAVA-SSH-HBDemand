...
<div align="center" style="margin-top:50px;margin-bottom:50px">技术审核的征集表信息</div>
	<table>
		<tr>
		  <p>---------------------------------------------------------------选择检索条件--------------------------------------------------------------</p>
		</tr>
...
<p align="center">
<a href = "jstjcx.jsp?curPage=1" >首页</a>  
<a href = "jstjcx.jsp?curPage=<%=curPage-1%>" >上一页</a>  
<a href = "jstjcx.jsp?curPage=<%=curPage+1%>" >下一页</a>  
<a href = "jstjcx.jsp?curPage=<%=pageCount%>" >尾页</a>  
