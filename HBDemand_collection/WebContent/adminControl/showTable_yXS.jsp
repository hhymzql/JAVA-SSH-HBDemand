...
<div align="center" style="margin-top:50px;margin-bottom:50px">形式审核通过的征集表信息</div>
...
try{
    ...
    String sql = "select NO,cmadName,keyword1,keyword2,SHstate from tb_Comand where SHstate = 1 and XSstate = 1";
...
<p align="center">
<a href = "showTable_yXS.jsp?curPage=1" >首页</a>  
<a href = "showTable_yXS.jsp?curPage=<%=curPage-1%>" >上一页</a>  
<a href = "showTable_yXS.jsp?curPage=<%=curPage+1%>" >下一页</a>  
<a href = "showTable_yXS.jsp?curPage=<%=pageCount%>" >尾页</a>  
