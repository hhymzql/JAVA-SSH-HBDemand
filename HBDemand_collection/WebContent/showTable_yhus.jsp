...
<table border="1" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr>
   ...
   <td colspan="4"><%=rs1.getString(29)%></td>
  </tr>
</table>
	<%
		request.setCharacterEncoding("UTF-8");
	    ...
	    {
	    	ResultSet rs = db.executeQuery("update tb_Comand set XSstate = 1 where NO = '" + NO + "'");
	    	out.println("<script language='javaScript'> alert('审核通过!');top.location.href='index_xssh.jsp';</script>");
	    }
	%>
</form>
</body>
